...
public class GlowZombie extends GlowMonster implements Zombie {
    ...
    public void setVillager(boolean value) {
        if (value) metadata.set(MetadataIndex.ZOMBIE_IS_VILLAGER, getVillagerProfession().getId());
    }

    @Override
    public void setVillagerProfession(Profession profession) {
        metadata.set(MetadataIndex.ZOMBIE_IS_VILLAGER, profession.getId());
    }

    @Override
    public Profession getVillagerProfession() {
        return Profession.getProfession(metadata.getInt(MetadataIndex.ZOMBIE_IS_VILLAGER));
    }
